            ...
            <Grid container style={{ backgroundColor: 'rgb(241,248,248)'}}>
                ...
                <Grid item xs={12} md={7} >
                    <Grid container style={{ height: '100%',width:'100%'  }}>
                        {/* <Grid item xs={3} md={3} style={{ border: '2px solid purple' }}> */}
                        {/* </Grid> */}
                        <img src={svgImage} className='svgImage' />
                        <Grid item xs={12} md={12} padding={12} style={{ display: 'flex', justifyContent: 'center',
                            alignItems: 'center', height: '100%',width:'100%' // Set height to 100%
                        }}>
                            {/* Main div */}
                            <div>
                ...
                <Grid item xs={12} md={5} >
                    <div style={{
                        ...
                        <div >
                            <img src={GirlImage} style={{ width: '100%', height: '100%' }} />
                        </div>
                    </div>
                </Grid>
